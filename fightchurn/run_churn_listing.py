...
parser.add_argument("--chapter", type=int, help="The chapter of the listing", default=7)
parser.add_argument("--listing", nargs='*', type=int, help="The number of the listing", default=[8])
